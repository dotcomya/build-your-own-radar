...
// La même palette qu'à l'écran : un document qui sort de Fynomia doit ressembler
// à Fynomia. Encre presque noire, un seul bleu de signal, et le vert / rouge /
...
export function buildDeck(scenario, result, profile) {
  ...
  slides.push(slideXml([
    ...
    textBox({
      ...
      text: "Prévisionnel établi avec Fynomia. Les montants sont exprimés hors taxes. Les paramètres fiscaux et sociaux sont des valeurs de référence à confirmer auprès d'un expert-comptable avant tout usage officiel.",
...
<a:theme xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main" name="Fynomia">
<a:themeElements>
<a:clrScheme name="Fynomia"><a:dk1><a:srgbClr val="0A0F1C"/></a:dk1><a:lt1><a:srgbClr val="FFFFFF"/></a:lt1><a:dk2><a:srgbClr val="1F2940"/></a:dk2><a:lt2><a:srgbClr val="F5F7FA"/></a:lt2>
...
<a:fontScheme name="Fynomia"><a:majorFont><a:latin typeface="Aptos Display"/><a:ea typeface=""/><a:cs typeface=""/></a:majorFont><a:minorFont><a:latin typeface="Aptos"/><a:ea typeface=""/><a:cs typeface=""/></a:minorFont></a:fontScheme>
<a:fmtScheme name="Fynomia">
...
<Application>Fynomia</Application><Slides>${n}</Slides><Company>${xml(scenario.meta.company || '')}</Company>
</Properties>`
...
<dc:creator>${xml(profile?.name || 'Fynomia')}</dc:creator>
<cp:lastModifiedBy>${xml(profile?.name || 'Fynomia')}</cp:lastModifiedBy>
