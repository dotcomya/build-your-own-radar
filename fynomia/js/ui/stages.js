...
export const STAGES = [
  ...
  },
  {
    ...
    says: "Ton modèle existe. Ce qui manque, c'est ce qu'un lecteur extérieur vérifiera : ton coût de revient, tes délais de paiement, ta rémunération.",
    lift: ['cout', 'delai', 'salaire', 'charges', 'acquisition', 'pitch'],
  ...
  },
  {
    ...
    lift: ['charges', 'delai', 'equipe', 'cout', 'salaire', 'churn'],
