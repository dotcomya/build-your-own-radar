...
export function refinePanel(navigate, { compact = false } = {}) {
      ...
      ...c.groups.map((g) => h('div', { class: `refinery-group ${g.done === g.total ? 'is-full' : ''}` },
        ...
        h('div', { class: 'refinery-items' },
          ...g.items.map((it) => h('button', {
            class: `refinery-item ${it.done ? 'is-done' : ''}`,
            title: it.done ? 'Revoir' : 'Renseigner',
            ...
            h('span', { class: 'refinery-text' },
              ...
              it.done ? null : h('span', { class: 'refinery-why' }, it.why),
            ),
