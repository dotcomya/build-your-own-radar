...
export const GLOSSARY = {
  pointMort: {
    ...
    how: "Fynomia additionne tout ce que vous payez quel que soit votre volume de ventes — salaires, loyer, assurances, amortissements, intérêts d'emprunt — puis divise ce total par la part de chaque euro vendu qui reste après avoir payé les coûts directement liés à la vente.",
  ...
  margeBrute: {
    ...
    how: "Pour chaque offre, Fynomia multiplie les volumes par le coût unitaire que vous avez renseigné, puis le retire du chiffre d'affaires.",
  ...
  bfr: {
    ...
    how: "Fynomia suit mois par mois l'écart entre le chiffre d'affaires facturé et encaissé, ainsi qu'entre les achats engagés et payés, en appliquant les délais que vous avez saisis.",
  ...
  cac: {
    ...
    how: "Fynomia déroule votre entonnoir : budget divisé par le coût du clic, multiplié par le taux de transformation en contact, puis par le taux de transformation en client.",
  ...
  superBrut: {
    ...
    watch: "Les taux dépendent de votre convention collective et de votre taux d'accident du travail. Ceux de Fynomia sont des moyennes de marché, ajustables dans les réglages.",
  },
  tva: {
    title: 'TVA',
  ...
  cir: {
    ...
    how: "Fynomia retient la part du temps que vous avez déclarée en recherche pour chaque salarié, y ajoute un forfait de frais de fonctionnement de 43 %, les amortissements du matériel de recherche majorés de 75 %, et la sous-traitance agréée plafonnée à trois fois les autres dépenses. Les subventions perçues viennent en déduction.",
  ...
  jei: {
    ...
    how: "Fynomia calcule chaque année le rapport entre vos charges de recherche et vos charges totales, puis applique l'exonération sur la part de salaire inférieure à 4,5 SMIC.",
