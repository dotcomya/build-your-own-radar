...
export function monthlyCost(member, { headcount = 1, jeiActive = false, fiscal = {}, benefits = {} } = {}) {
  ...
  if (jeiExemption > 0) {
    detail.push({
      ...
      amount: -jeiExemption,
      note: `Assurances sociales et allocations familiales (${pct(jeiCfg.exemptibleRate)} du brut) sur la fraction inférieure à 4,5 SMIC, soit ${fmt(jeiCap)} €. Chômage, retraite complémentaire et accidents du travail restent dus. Non cumulable avec la réduction générale : Fynomia retient le dispositif le plus favorable.`,
    })
  }
