# Fynomia — construisez votre business plan
...
Vous saisissez ce que vous vendez, à qui, avec quelle équipe. Fynomia en déduit
...
- **Onze questions, une par écran.** Un prévisionnel demande une soixantaine de
  ...
  en demande onze, dans l'ordre où elles se répondent, et Fynomia déduit le reste.
...
- **Salaires.** Vous saisissez un brut mensuel, Fynomia calcule le coût réel :
...
- **Un compte, et des plans qui suivent.** Le navigateur d'abord — instantané,
  ...
  Fynomia ne conserve aucun secret et ne gère aucun mot de passe. Sans compte
