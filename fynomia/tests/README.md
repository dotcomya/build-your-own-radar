...
| `15-pitch` | l'onglet pitch : le récit en analyse stratégique (cinq chapitres, un objectif chacun, le diagnostic à gauche et la courbe à droite, la courbe en J, le banquier, le stress test, l'essentiel en clair et la question à préparer, sans personnage) ; le tableau en tuiles claires ; les diapos blanches avec quatre intercalaires sombres ; « En détail » avec son sommaire de six parties et ses explications repliées ; le besoin affiché est celui du moteur ; au téléphone sans débordement |
