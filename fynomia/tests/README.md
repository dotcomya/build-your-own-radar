...
| `15-pitch` | la synthèse : le récit en neuf scènes dans l'ordre demandé (chiffre d'affaires, résultat, ventes, économie d'une vente, équipe, coûts, trésorerie, financement, hypothèses), une à la fois, avec sa barre d'étapes, « Précédent », « Suivant » et les flèches du clavier ; chaque scène a sa question, son grand chiffre, sa conclusion, ses repères et son dessin sur panneau sombre ; « Comprendre ce chiffre » ouvre un tiroir à droite (chiffres commentés, évolution A1–A5, lecture, module source) ; « Voir les données » pose l'état financier sur fond flouté, lignes du chapitre surlignées, et la trésorerie se rapproche au centime ; la cascade tombe sur le résultat net, le besoin sur celui du moteur ; les diapos ; « En détail » et ses neuf parties ; au téléphone sans débordement |
...
| `25-survol` | dans le récit du pitch, chaque donnée se consulte au survol : les cinq barres et les soixante mois de tête, la trajectoire, la cascade du résultat, la courbe de trésorerie, chaque barre des scènes qui en portent ; l'infobulle dit la période, l'intitulé et la valeur exacte du moteur |
| `26-formats` | trois lectures du même projet : aucune ne nomme un lecteur ni ne fait parler un personnage ; le besoin, le mois du point bas, le premier bénéfice et le chiffre d'affaires de l'année 5 se lisent dans chacune, identiques ; le récit pose une question et y répond par scène, chaque diapositive tient en une phrase courte, le détail expose les hypothèses et ce qui les justifie |
...
| `33-suggestions` | les suggestions du métier : « Suggestions pour un glacier », le compteur, trois pastilles blanches au « + » jaune puis « +N » ; déplier sur place, replié au retour sur la page ; « pour une pizzeria » au féminin |
